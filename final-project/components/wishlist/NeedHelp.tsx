        ...
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Fast response anytime.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold">Trusted by Cosplayers</h3>

              <p className="text-sm text-gray-500">Thousands of happy users.</p>
            </div>
          </div>
        </div>
      </div>
