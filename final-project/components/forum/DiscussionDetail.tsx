    ...
    <article className="card overflow-hidden">
      ...
      <div className="px-8">
        ...
        <p className="mt-6 max-w-4xl leading-8 text-[var(--muted)]">
          ...
          I'm currently working on my Frieren cosplay and struggling
          with styling the wig to get that soft natural look.
          ...
          Does anyone have recommendations for layering, thinning,
          or products that work well?
